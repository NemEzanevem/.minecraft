ServerEvents.recipes(event => {
    ...
    event.recipes.createMixing('1x pointblank:gunmetal_ingot', ['1x kubejs:hot_gunmetal_ingot', Fluid.of('minecraft:water', 1000)])
...
ServerEvents.recipes(event => {
  ...
  ServerEvents.recipes(event => {
    ...
    event.recipes.create.sequenced_assembly([
      Item.of('pointblank:gunmetal_mesh'), ], 'createbigcannons:nethersteel_ingot', [
